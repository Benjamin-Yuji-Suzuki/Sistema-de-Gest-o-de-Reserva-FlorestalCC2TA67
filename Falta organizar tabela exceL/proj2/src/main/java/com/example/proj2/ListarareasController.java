...
public class ListarareasController {
    ...
    public void atualizarTableView() {
        areasTable.getItems().clear();  // Limpar a tabela antes de adicionar novos dados

        // Buscar todas as áreas do banco de dados
        List<Area> areas = AreaDAO.buscarTodasAreas();  // Certifique-se de que esse método existe

        // Adicionar as áreas encontradas na tabela
